...
@Component
public class AlbionParkRecordConverter implements RecordConvertable<SectionalDataRecord> {
    ...
    public SectionalDataRecord convert(String[] tokenArray,
        ...
        return SectionalDataRecord.builder()
                ...
                .raceNo(TokenParser.parseIntegerToken(tokens.get(2)))
                .tabNo(TokenParser.parseIntegerToken(tokens.get(3)))
                .horseName(tokens.get(4))
                .horseImportedCountry(tokens.get(5))
                ...
                .race400FinishTime(tokens.get(15))
                .build();
    }
